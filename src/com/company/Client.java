...
public class Client extends JFrame {
    ...
    Client() {
        ...
        ImageIcon profile1 = new ImageIcon(ClassLoader.getSystemResource("com/company/Icons/profile2.png"));
        Image profile2 = profile1.getImage().getScaledInstance(48, 48, Image.SCALE_DEFAULT);
        ImageIcon profile3 = new ImageIcon(profile2);
        JLabel profile1L = new JLabel(profile3);
        profile1L.setBounds(50, 6, 50, 50);
        p1.add(profile1L);

        JLabel name1 = new JLabel("Olivia James");
